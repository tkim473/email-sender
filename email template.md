<mjml>
  ...
  <mj-body>
    <mj-section padding="20px 0">
      <mj-column width="60%">
        <mj-text font-size="10px">Kim Fam custom newsletter is here!</mj-text>
      </mj-column>
      <mj-column width="40%">
    ...
    <mj-section>
      <mj-column width="100%">
        <mj-text align="center">Your custom intake of goal progress, reminders, weather, relevant news. </mj-text>
      </mj-column>
    </mj-section>
    <mj-section>
      <mj-column width="45%">
        <mj-text align="center" font-weight="500" padding="0px" font-size="18px">[TBD DYNAMIC DATE] MARCH 26</mj-text>
    ...
    <mj-section padding-top="30px">
      <mj-column width="100%">
        <mj-text>
          <p>Let's start with the weather!</p>
          <p> With everyone spread around the world, here's your weather snapshot. </p>
    ...
    <mj-section>
      ...
      <mj-column width="89%">
        <mj-text padding="0 25px">
          <p style="color:#BDBDBD; line-height: 9px"> Tim Kim Bot </p>
          <p style="font-style: italic; color:#BDBDBD; line-height: 9px"> Your unemployed, automated bot service. </p>
        </mj-text>
      </mj-column>
    </mj-section>
    <mj-section>
